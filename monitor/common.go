...
func (m *Monitor) getRequest(channelId []byte, receiver string) (guard.Request, error) {
	return guard.CLIQueryRequest(m.operator.CliCtx, guard.RouterKey, channelId, receiver)
}
